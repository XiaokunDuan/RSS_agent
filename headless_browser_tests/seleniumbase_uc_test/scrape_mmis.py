...
if __name__ == "__main__":
    ...
    # 1. 目标期刊的所有卷期列表页
    journal_loi_url = "https://www.tandfonline.com/loi/mmis20"
    ...
    output_filename = f"MMIS_articles_{target_year}_latest_{num_latest_issues_to_scrape}_issues.csv"
